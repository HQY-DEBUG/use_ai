...
* **macOS**（适用于 Intel 和 Apple Silicon 的通用版本）：[下载](https://claude.ai/api/desktop/darwin/universal/dmg/latest/redirect)
* **Windows**（适用于 x64 处理器）：[下载](https://claude.ai/api/desktop/win32/x64/exe/latest/redirect)

对于 Windows ARM64，[在此下载](https://claude.ai/api/desktop/win32/arm64/exe/latest/redirect)。
